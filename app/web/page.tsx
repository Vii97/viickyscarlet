...
import {
  ...
  SiClaude, SiGit, SiGithubcopilot,
} from "react-icons/si";
...
const projects = [
  ...
  },
  {
    ...
    stack: ["Next.js", "Zod", "React Hook Form", "TypeScript", "Cloudfare Workers","Brevo", "Discord Webhook", "Lucide React"],
    type: "Contacto",
  ...
  },
  {
    id: 3,
    title: "About Me",
    subtitle: "Portfolio minimalista",
    url: "https://about-mevicky.vercel.app/",
    stack: ["Next.js", "Vercel"],
    type: "Personal",
    description: "Presentación de mi GitHub y Artstation en el ecosistema de Vercel. El diseño y las animaciones mediante keyframes de CSS fueron una pieza clave de identidad en mi trabajo final de DAW.",
  },
  {
    id: 4,
    title: "Dani Díaz Fotógrafo",
    subtitle: "Noticias y galería fotográfica",
    url: "https://fot-exy.pages.dev/",
    stack: ["Astro", "Sanity", "TypeScript","API Open-Meteo"],
    type: "Cliente",
  ...
  },
  {
    id: 5,
    title: "Quiz BDO Rol",
    subtitle: "Test de personalidad",
    url: "https://quiz-bdo-rol.vercel.app/",
    stack: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],
    type: "Cuestionarios",
    description: "App de quizs de mis OCs en Black Desert con los que roleo ¡Fue mi primer proyecto en Next.js desplegado en Vercel!",
  },
  {
    id: 6,
    title: "The Movie DB",
