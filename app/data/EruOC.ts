export const EruOC = {
    ...
    combat: [
        ...
        "Tenderá a ser pacífico, pero sus flechas son poderosas, valiéndose de su energía élfica que se manifiesta como luminosas chispas y rayos que nacen de su cuerpo, incluso a veces él brilla como una cálida luciérnaga cuando sienta una emoción muy fuerte."
    ],
    job: "Florista 🪻",
    personality: [
        ...
        "Suele alargar las vocales, se traba o directamente se bloquea, pero siempre va a ser emocional y sincero, incapaz de mentir, hablando desde el corazón.",
    ...
    story: [
        ...
        "En general tiene un historial de trabajos temporales bastante grande, sin embargo, ha sido la excusa perfecta para viajar por el mundo, sobreviviendo a numerosas situaciones. Actualmente vive con cierta chica pelirroja en Heidel, con su propia floristería en la cual por fin ha encontrado la estabilidad que buscaba."
    ],
    description: [
    ...
    storyTime: "Eru es mi niño. Es mi modelo para dibujar y escribir, mi lugar seguro, mi comfort-character. Tiene a sus padres a pesar de todo, a su hermana, y ahora a gente que le quiere después de tantos problemas para hacerse un hueco en el mundo. Es muy tímido y tiene 0 autoestima. Interioriza mucho ese tipo de temas y, aunque sea un elfo, no se siente superior ni etéreo. Cualquiera podría sentir cierta empatía por él, puesto que lo importante de su historia no es el luchar contra las peores bestias oscuras y dramáticas, sino el superarse, en salir adelante, en encontrar un poquito de paz en este mundo tan caótico ¿Elfo rubio y de ojos azules? Pfff… es lo más típico que pudiera haber ¿verdad? Muchos lo han llamado Legolas o Link, porque es de lo que más se inspira, pero también quise darle una vuelta para que se sintiera más natural y menos perfecto, más desastre y menos grácil. Y le quiero mucho por ello <3 ¡Espero seguir haciendo más cositas sobre él! Dibujarle me cura todos los males.",
    song: "https://www.youtube.com/watch?v=-w2m-TeLi6I",
    player: "ELUVEITIE - The Call Of The Mountains",
    relatedLinks: [
        { label: "Cosplay", href: "/coslay/eru" }, 
        { label: "Art", href: "/art/black-desert" },
        { label: "Virtual Photography", href: "/virtual-photography/black-desert/archer" }
    ]
}

export default EruOC