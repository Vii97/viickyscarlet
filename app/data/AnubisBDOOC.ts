export const AnubisBDOOC = {
    ...
    storyTime: "Hacía ya bastante tiempo que tenía mucha curiosidad por llevar a un pícaro. En 2021-2022 empecé a crear a este man con nombre de dios egipcio (que para variar soy muy fan~). Quería dejar claros sus límites: no es mala persona, solo es un antihéroe que tuvo una vida dura en el desierto, no es un guerrero, no tiene apenas dinero, no conoce mucho sobre la historia de su madre, no sabe leer, no sabe nadar. Pero sí tiene un corazón más grande del que aparenta, un diamante en bruto como dirían en Aladdín, le sobra valentía… ¡y la de veces que vino de bien el que fuese el experto en forzar cerraduras de tantos cofres y puertas! Y experto en colarse en sitios sigilosamente, en lanzar una piedra y esconderse… ¡Su papel se volvió hasta adictivo! Al principio ninguno dimos un duro por él y su presencia en los roles, que sería algo de una temporadilla corta, pero aquí está él, robando un montón de espacio en nuestros corazones desde entonces. Y es de los personajes que casi no han parado de vivir cosas… Ha descubierto verdades que dolieron, también se ha asustado, se ha deprimido muchísimo… y a pesar de eso sigue adelante, aprende, vive en libertad y su sonrisa seguirá ahí.",
    song: "https://www.youtube.com/watch?v=pEaK-4LEJqk",
    player: "Awake again - Dark Horse",
    relatedLinks: [
        { label: "Art", href: "/art/black-desert" },
        { label: "Virtual Photography", href: "/virtual-photography/black-desert/hashashin" }
    ]
}

export default AnubisBDOOC
