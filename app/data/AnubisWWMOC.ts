export const AnubisWWMOC = {
    ...
    storyTime: "“Todos merecen una segunda oportunidad”. Podría resumir todo este apartado en esa frase. Al principio pensé en llevar al Anubis de Black Desert a este juego, pero había muchas inconsistencias y al final uno se estaba desligando del otro. Su nombre, su aspecto y parte de su historia se sienten iguales, pero tienen marcadas diferencias. La primera de ellas es la cultura asiática, las costumbres chinas, todo el entorno en la época del siglo X de China. Aquí no hay ninguna ciudad de estilo árabe en medio del desierto, de hecho, no hay ninguna ciudad de ese estilo. El concepto del jianghu me resultó muy interesante y es algo por lo que se mueve el juego, así que decidí hacer a un Anubis más viajero que vaya por su cuenta, más autosuficiente, sabe manejar la espada y es alguien un pelín más maduro que ya ha tomado ciertas decisiones en su vida. Fue un ladrón. Tuvo muchas complicaciones. Vivió mucho y quiso darle una vuelta a su vida. Elige más sus bromas, elige más a quien sonreír y a quien no, controla más incluso su faceta de “semichacal” ¡Es muy interesante y divertido de explorar dentro de este mundo asiático lleno de posibilidades!",
    song: "https://www.youtube.com/watch?v=U3ge-kGhY04",
    player: "Where Winds Meet Main Theme",
    relatedLinks: [
