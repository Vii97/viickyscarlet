export const YzhelOC = {
    ...
    storyTime: "De los OCs que os presento en la web, Yzhel es el único que vive en la época actual. Es una persona como tú o como yo, pero con unas raíces muy fuertes de montaña solitaria en un ambiente frío. Tenía ganas de llevar un personaje así en algún rol, el personaje con la faceta más artística y bohemia que tiene que dárselas de artista independiente por Internet para sobrevivir al alquiler de su piso. Es un “raro” con un sentido del humor bastante roto, pero… lo tiene, algo que saca a relucir cuando usa el poder del viento y esa faceta de “chico artista con una vida normal” se le queda corta. Aunque no se considere un héroe, muchas veces puede llegar a ser un amigo y vecino Spiderman venido del norte de Europa. Aprovecho un rol de foro inspirado en Boku No Hero para llevarlo (¡seguro que a más de un fan le ha sonado por eso del quirk y los héroes!) lo cual me está gustando porque escribir es muy relajado y me sienta de maravilla.",
    song: "https://www.youtube.com/watch?v=x48hbmwoIa8",
    player: "Joel Hokka - No One There (Reimagined)",
    relatedLinks: [
        { label: "Art", href: "/art/yzhel" },
    ]
}

export default YzhelOC    