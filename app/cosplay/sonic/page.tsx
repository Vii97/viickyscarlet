...
export const cosplaySonic = [
    {
        id: 1,
        src: "https://pbs.twimg.com/media/GRjtRgVXQAA5gKA?format=jpg&name=4096x4096",
        alt: "maria",

    },
    {
        id: 2,
        src: "https://pbs.twimg.com/media/GbDuJruXMAAV8VV?format=jpg&name=4096x4096",
        alt: "maria",

    },   
    {
        id: 3,
        src: "https://pbs.twimg.com/media/GbDuJjrXYAABCRY?format=jpg&name=large",   
        alt: "maria",
    },
        {
        id: 5,
        src: "https://pbs.twimg.com/media/GSSHRMLWcAA6Kkp?format=jpg&name=large",   
        alt: "psikowilliams",
    },
    {
        id: 6,
        src: "https://pbs.twimg.com/media/Gc6xAYzX0AA1JFk?format=jpg&name=4096x4096",   
        alt: "psikowilliams",
    },
      {
        id: 4,
        src: "https://pbs.twimg.com/media/GTF2OAkXoAAjsc2?format=jpg&name=large",   
        alt: "psikowilliams",
    },
    {
        id: 7,
        src: "https://pbs.twimg.com/media/Gg3PdL3XYAABq3W?format=jpg&name=4096x4096",   
        alt: "ivanska",
    },    
    {
        id: 8,
        src: "https://pbs.twimg.com/media/GXHKCSWXkAALbsZ?format=jpg&name=large",   
        alt: "ivanska",
    }, 
    {
        id: 9,
        src: "https://pbs.twimg.com/media/Gndp2DeXMAAYzin?format=jpg&name=large",   
        alt: "ivanska",
    },
    {
        id: 10,
        src: "https://pbs.twimg.com/media/GreTS0XWQAAzAO7?format=jpg&name=large",   
        alt: "ivanska",
    },
    {
        id: 11,
        src: "https://pbs.twimg.com/media/GdzUgUtXMAAiHn2?format=jpg&name=large",   
        alt: "mansi",
    },
    {
        id: 12,
        src: "https://pbs.twimg.com/media/FjfGyypXkAIFUPh?format=jpg&name=4096x4096",   
        alt: "fjgkl",
    },
    {
        id: 13,
        src: "https://pbs.twimg.com/media/GHBfrKHWYAA1ikR?format=jpg&name=4096x4096",   
        alt: "ijfskf",
    },
    {
        id: 14,
        src: "https://pbs.twimg.com/media/GHBfrKBWkAEmHQ7?format=jpg&name=large",   
        alt: "adrii",
    },
    {
        id: 15,
        src: "https://pbs.twimg.com/media/GHBfrJ8W8AAR0-k?format=jpg&name=large",   
        alt: "adrii",
    },
    {
        id: 16,
        src: "https://pbs.twimg.com/media/F8Ju2RgWIAAP8RS?format=jpg&name=large",   
        alt: "silver",
    },
    {
        id: 17,
        src: "https://pbs.twimg.com/media/F8Ju2nQWMAAWcMc?format=jpg&name=large",   
        alt: "silver",
    },
]
